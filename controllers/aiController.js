...
- FAITHFUL TEXT: reproduce the wording EXACTLY as printed — same words, same order, same punctuation. Keep every special symbol/marker exactly where it appears in the line (e.g. ▲ ■ ● ► ◆ ★ • and footnote/superscript numbers like ¹ ² ³). Never drop, move, or normalize these marks.
- EMPHASIS — preserve italic and bold, ESPECIALLY in reading passages and any word the question highlights. Wrap an italicised word/phrase in *single asterisks* and a bold one in **double asterisks** (Markdown), e.g. the italic words in a "mətn" or a word shown in italics inside a question. Apply it everywhere the PDF italicises/bolds text; leave normal text unmarked.
